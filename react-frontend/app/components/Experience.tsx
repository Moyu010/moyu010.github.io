  ...
  return (
    <div className="space-y-4">
      {experiences && experiences.map((exp, index) => (
        <div key={index} className="block p-6 max-w-full bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100">
          <div className="flex space-x-4">
            ...
            <div>
              ...
              <p className="font-normal text-gray-700">{exp.startDate.toDateString()} - {exp.endDate.toDateString()}</p>
            </div>
          </div>
